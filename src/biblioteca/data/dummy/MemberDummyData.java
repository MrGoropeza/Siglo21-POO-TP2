...
public class MemberDummyData {
        ...
        public static List<Member> getMembers() {
                ...
                // Estudiantes
                members.add(new Member("2001", "Ana Martínez", "ana.martinez@estudiante.edu", "555-0201",
                                MemberType.STUDENT));
                ...
                members.add(new Member("2003", "Lucía Fernández", "lucia.fernandez@estudiante.edu", "555-0203",
                                MemberType.STUDENT));
                members.add(
                                new Member("2004", "Miguel Torres", "miguel.torres@estudiante.edu", "555-0204",
                                                MemberType.STUDENT));

                // Jubilados
                members.add(new Member("3001", "Roberto Silva", "roberto.silva@email.com", "555-0301",
                                MemberType.RETIRED));
                members.add(new Member("3002", "Elena Morales", "elena.morales@email.com", "555-0302",
                                MemberType.RETIRED));
                members.add(new Member("3003", "José Herrera", "jose.herrera@email.com", "555-0303",
                                MemberType.RETIRED));
